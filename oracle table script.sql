-- Create admin table
CREATE TABLE admin (
    admin_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
...
-- Create parent table
CREATE TABLE parent (
    parent_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
    password VARCHAR(45) NOT NULL,
    user_name VARCHAR(45) NOT NULL UNIQUE,
    name VARCHAR(256) NOT NULL,
    email VARCHAR(45) NOT NULL,
...
CREATE TABLE classroom (
    classroom_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
    grade INT NOT NULL,
...
CREATE TABLE material (
    material_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
...
-- Create mark table
CREATE TABLE mark (
    mark_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
    fk_material_id INT NOT NULL,
...
CREATE TABLE announcement (
    announcement_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE attendance (
    attendance_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
    fk_student_id INT NOT NULL,
    fk_classroom_id INT NOT NULL,
    date_submmitted DATE NOT NULL,
...
CREATE TABLE certification (
    certification_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
    fk_teacher_id INT NOT NULL,
    fk_student_id INT NOT NULL,
...
CREATE TABLE library (
    library_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE third_party_integration (
    integration_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE admission (
    admission_id INT GENERATED ALWAYS AS IDENTITY NOT NULL,
    fk_student_id INT NOT NULL,
